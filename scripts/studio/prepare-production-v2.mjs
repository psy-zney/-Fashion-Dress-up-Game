...
await fs.writeFile(`${out}/ready.json`, JSON.stringify({ version: 'production-v2-20260909-v11-yellow-tucked', catalogGarments: items.length, items, poses: ['top-fitted-denim-pose', 'top-modal-grommet-pose'], updatedAt: new Date().toISOString() }, null, 2) + '\n');
const report = [];
